...
public class ActivityLoginEmail extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (auth.getCurrentUser() != null) {
            //startActivity(new Intent(ActivityLoginEmail.this, MainActivity.class));
            //finish();
        }
        ...
        btnSignup = (FrameLayout) findViewById(R.id.btn_signup);
        ...
        btnSignup.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(ActivityLoginEmail.this, ActivityRegister.class));
            }
        });
        ...
        btnReset.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                //startActivity(new Intent(ActivityLoginEmail.this, PasswordResetActivity.class));
            }
        });
                            ...
                            public void onComplete(@NonNull Task<AuthResult> task) {
                                ...
                                if (!task.isSuccessful()) {
                                    ...
                                    if (password.length() < 6) {
                                        inputPassword.setError("Minimum Password Issue!");
                                    } else {
                                        Toast.makeText(ActivityLoginEmail.this,"Authentication Failed !", Toast.LENGTH_LONG).show();
                                    }
                                } else {
