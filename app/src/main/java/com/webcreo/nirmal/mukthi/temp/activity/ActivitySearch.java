...
import com.webcreo.nirmal.mukthi.temp.adapter.AdapterSearchSuggestion;
...
public class ActivitySearch extends AppCompatActivity {
    ...
    private AdapterSearchSuggestion mAdapterSuggestion;
    ...
    private void initComponent() {
        ...
        mAdapterSuggestion = new AdapterSearchSuggestion(this);
        recyclerSuggestion.setAdapter(mAdapterSuggestion);
        showSuggestionSearch();
        mAdapterSuggestion.setOnItemClickListener(new AdapterSearchSuggestion.OnItemClickListener() {
            @Override
            public void onItemClick(View view, String viewModel, int pos) {
                et_search.setText(viewModel);
                HelperAnimation.collapse(lyt_suggestion);
                hideKeyboard();
                searchAction();
            }
        });
    ...
    private void showSuggestionSearch() {
        ...
        HelperAnimation.expand(lyt_suggestion);
    }
