...
public class AdapterRECollections extends RecyclerView.Adapter
{
    private List<ModelBase> mCategories;
    private Context mContext;

    public AdapterRECollections(Context context, List<ModelBase> categories)
    {
    ...
    {
        View itemView = LayoutInflater.from(parent.getContext()).inflate(R.layout.adapter_re_collections, parent, false);
    ...
    {
        return Math.min(mCategories.size(),4);
    }
