package com.webcreo.nirmal.mukthi.temp.helper;
...
public class AnimationFadeInFadeOut extends LinearLayout {
    ...
    public AnimationFadeInFadeOut(Context context) {
        super(context);
    }

    public AnimationFadeInFadeOut(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
    ...
    public AnimationFadeInFadeOut(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
