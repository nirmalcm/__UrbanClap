...
public class ViewDotsBounce extends LinearLayout {
    ...
    public ViewDotsBounce(Context context) {
        super(context);
    }

    public ViewDotsBounce(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
    ...
    public ViewDotsBounce(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
