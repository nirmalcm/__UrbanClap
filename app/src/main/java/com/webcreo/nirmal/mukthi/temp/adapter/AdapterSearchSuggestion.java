...
public class AdapterSearchSuggestion extends RecyclerView.Adapter<AdapterSearchSuggestion.ViewHolder> {
    ...
    public AdapterSearchSuggestion(Context context) {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.adapter_search_suggestion, parent, false);
