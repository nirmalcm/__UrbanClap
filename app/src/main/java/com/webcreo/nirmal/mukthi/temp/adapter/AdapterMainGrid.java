...
import com.webcreo.nirmal.mukthi.temp.activity.ActivityMore;
...
public class AdapterMainGrid extends RecyclerView.Adapter
{
    private List<ModelBase> services;
    private Context context;

    public AdapterMainGrid(Context context, List<ModelBase> services)
    {
    ...
    {
        View itemView = LayoutInflater.from(parent.getContext()).inflate(R.layout.adapter_main_grid, parent, false);
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, final int position)
    {
        ...
        viewHolderSub.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (services.get(position).isMore()){
                    Intent intent = new Intent(context, ActivityMore.class);
                    Bundle bundle = new Bundle();
                    bundle.putSerializable("data",new ArrayList<>(services));
